...
Let't take a look at what we made.
...
```{r}
#| label: fig-complete
#| fig-cap: Average choice (±SE) as a function of language (Spanish, English)
...
And a plot to see how or model compares to the descriptives: 
